...
import { GiIsland,GiWaterDrop,GiChimney,GiCeilingLight,GiHalfBodyCrawling,GiHeatHaze,GiPowerLightning,GiHomeGarage,GiRat } from "react-icons/gi";
  ...
  return (
    <div>
      ...
      <section className="top-section">
        <img
          src="https://i.imgur.com/9a18MSR.jpg"
          alt="Property"
      ...
      <main className="main-section">
        ...
        <h1 className="main-subheader">Standard Home Inspection~Typically takes 2-3 hrs. Includes the following:</h1>
        ...
        <div className="icon-section">
          ...
          <GiChimney className='home-icon'/>
            <p>Roof, vents, chimney, flashings and trim, gutters and downspouts</p>
          </div>
